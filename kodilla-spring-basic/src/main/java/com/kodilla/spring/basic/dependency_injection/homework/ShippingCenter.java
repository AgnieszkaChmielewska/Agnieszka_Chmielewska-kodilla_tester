...
public class ShippingCenter {
    private DeliveryService deliveryService = new DeliveryOfBigPackageService();
    private NotificationService notificationService = new NotificationAboutRegistration();
